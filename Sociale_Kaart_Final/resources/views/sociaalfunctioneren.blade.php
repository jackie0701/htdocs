...
<head>
    <meta charset="UTF-8"/>
    <meta name="description" content="Sociaal functioneren - Sociale Kaart"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>@yield('title', 'Sociaal functioneren') | Sociale kaart</title>
    @section('styles')
                        ...
                        <div class="col-md-9">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Sociaal functioneren</li>
                                </ol>
                            </nav>
