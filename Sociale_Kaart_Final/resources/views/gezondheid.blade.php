...
<head>
    <meta charset="UTF-8"/>
    <meta name="description" content="Gezondheid - Sociale Kaart"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>@yield('title', 'Gezondheid') | Sociale kaart</title>
    @section('styles')
                        ...
                        <div class="col-md-9">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Gezondheid</li>
                                </ol>
                            </nav>
