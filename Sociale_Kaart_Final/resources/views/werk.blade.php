...
<head>
    <meta charset="UTF-8"/>
    <meta name="description" content="Werk en dagbesteding - Sociale Kaart"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>@yield('title', 'Werk en dagbesteding') | Sociale kaart</title>
    @section('styles')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 filter-desktop">
                            ...
                            <div class="filter1">
                                <h4>Thema's</h4>
                                <div class="checkbox">
                                    <label><input id="begeleidingnaarwerk" type="checkbox">Begeleiding naar werk</label>
                                </div>
                                <div class="checkbox">
                                    <label><input id="dagbesteding" type="checkbox">Dagbesteding</label>
                                </div>
                            </div>
                            <br>
